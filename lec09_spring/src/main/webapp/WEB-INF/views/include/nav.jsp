	...
	<div id="nav_wrap">
		...
		<div class="search">
			<form action = "<c:url value = '/board'/>" method ="get">
				<!-- <input type="text" name = "board_title" placeholder="검색어를 입력하쇼"> -->
				<select name = "search_type">
					...
					<option value = "3"<c:if test="${paging.search_type == '3' }">selected</c:if>>제목 or 내용</option>
				</select>
				<input type = "text" name = "search_text" placeholder="검색어를 입력하쇼">
